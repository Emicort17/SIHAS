        ...
        return (
          <View style={styles.content}>
            <View style={styles.summary2}> 
              ...
              <Text style={styles.TextH}>Sin comidas por ahora. ¿Que te gustaria agregar hoy?</Text>
            </View>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabs}>
        <Pressable
          style={[
            styles.tab,
            activeTab === "Resumen" && styles.activeTab,
          ]}
        ...
        <Pressable
          style={[
            styles.tab,
            activeTab === "Horarios" && styles.activeTab,
          ]}
...
const styles = StyleSheet.create({
  ...
  tab: {
    ...
    alignItems: "center",
    padding: 20,
    boxShadow: "0 4px 5px rgba(0, 0, 0, 0.328)"
  },
  activeTab: {
    color: "#4CAF50",
